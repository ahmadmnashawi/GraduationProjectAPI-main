        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, null, null, 3, 5, 2, 3000.0, null },
                    { 3, null, null, 3, 55, 2, 3000.0, null },
                    { 4, null, null, 3, 56, 2, 3000.0, null },
                    { 5, null, null, 3, 123, 2, 3000.0, null },
                    { 6, null, null, 3, 136, 2, 3000.0, null },
                    { 7, null, null, 3, 7, 3, 3000.0, null },
                    { 8, null, null, 3, 45, 3, 3000.0, null },
                    { 9, null, null, 3, 88, 3, 3000.0, null },
                    { 10, null, null, 3, 102, 3, 3000.0, null },
                    { 11, null, null, 3, 9, 4, 3000.0, null },
                    { 12, null, null, 3, 27, 4, 3000.0, null },
                    { 13, null, null, 3, 89, 4, 3000.0, null },
                    { 14, null, null, 3, 135, 4, 3000.0, null },
                    { 15, null, null, 3, 33, 5, 3000.0, null },
                    { 16, null, null, 3, 44, 5, 3000.0, null },
                    { 17, null, null, 3, 122, 5, 3000.0, null },
                    { 18, null, null, 3, 134, 5, 3000.0, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Physics is a science that studies the general properties of matter and the laws that seek to modify its state or motion without changing its nature.", null, 1, 0, 2, null, "https://i.ibb.co/Jdw0mns/images-q-tbn-ANd9-Gc-S2kgzs-C9-Xz-Rm-Id-S9-L16-RTZtewm-XAx-OAJUeg-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8775) },
                    { 2, null, "Astrophysics is a branch of astronomy that studies the properties and physical phenomena of celestial bodies. It depends primarily on the spectrometer that analyzes starlight and shows the materials that make up it and the physical conditions prevailing on its surface and in its atmosphere.", null, 1, 0, 3, null, "https://i.ibb.co/ZSCB5Hb/images-q-tbn-ANd9-Gc-QUJte8veo0-ULHb-C-q81sdf8c53-UOSEgu30gg-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8796) },
                    { 3, null, "Radiation is the process by which energy such as subatomic particles is emitted and transmitted. This process is characterized by the transmission of energy in straight lines in a source through a known medium such as air, water or vacuum.", null, 1, 0, 4, null, "https://i.ibb.co/Pgyg0ZC/radiation2.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8804) },
                    { 4, null, "Heat is a physical measure of the feeling of hotness or coldness resulting from contact with an object", null, 1, 0, 5, null, "https://i.ibb.co/k0f640h/698ca25d-3356-4149-a215-453aab0309b2-Getty-Images-139944098.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8811) },
                    { 5, null, "Gravity is the mutual attraction between two bodies and its strength depends on the masses of the two bodies and the distance between them", null, 1, 1, 2, null, "https://i.ibb.co/8BqRr8m/images-q-tbn-ANd9-Gc-Sscuymg7-GI-Q-XSUUVOGf-WFvrsps-K-v4-Nag-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8821) },
                    { 6, null, "X-rays are similar to light rays, but they are more frequent. The most recent of them are objects under the influence of cathode rays. They were discovered by the scientist Roentgen and are sometimes called by his name. They are electromagnetic waves.", null, 1, 1, 3, null, "https://i.ibb.co/mhmFXnr/images-q-tbn-ANd9-Gc-Rhuwykc2qsn4l-KV517u-Eb-BTv-Gj8h-Pjt-Cd1-Iw-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8829) },
                    { 7, null, "Frequency is the number of waves or cycles that leave a known point or reach it per second. This word or convention is most often used in alternating electric current, light and sound waves.", null, 1, 1, 4, null, "https://i.ibb.co/Wc9fFDx/images-q-tbn-ANd9-Gc-Q9-BSu-I-9z7o72fy6c5y-K0t-UOH9po-YWz-FJRYA-s.png", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8836) },
                    { 8, null, "Gamma rays are special electromagnetic rays emitted by radium and some other radioactive materials", null, 1, 1, 5, null, "https://i.ibb.co/ZHR61BH/images-q-tbn-ANd9-Gc-R-g-CN7-XUYUe3-HVvynr-LTPf-ATy7-IHS-h-WTp8-A-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8843) },
                    { 10, null, "The hurricane is a region of low atmospheric pressure in which the winds move in a spiral movement towards the center, and the spiral movement is counterclockwise in the northern hemisphere and agrees with it in the southern hemisphere", null, 2, 0, 2, null, "https://i.ibb.co/g3N6SRs/images-q-tbn-ANd9-Gc-Rye0x-Bk-JWn8gj-L87-Ic-g-Qijx-H3p39-Jt5m-Tww-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8851) },
                    { 11, null, "What is the definition of land shake?It is a tremor in the earth's crust caused either by volcanic activity underground or by the movement of rocks below the surface", null, 2, 0, 3, null, "https://i.ibb.co/C9H8cs0/images-q-tbn-ANd9-Gc-Qx-Wq-SAQd-Vx5ms0i-Uz-Wn4ub-X6-J0-KUca-OOud-FA-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8859) },
                    { 12, null, "Soil in stratigraphy is the part of the Earth's surface that contains a mixture of rock particles, minerals and organic matter that helps plant growth", null, 2, 0, 4, null, "https://i.ibb.co/TLwP87r/images-q-tbn-ANd9-Gc-RORohfl-KFF8s-AWbp-SXCwb3-Ms-Ds-Pl-Ju-Zyb-THw-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8866) },
                    { 13, null, "The South Pole is the southernmost point on the Earth's surface, and it is one of two points that border the imaginary line that represents the axis of rotation of the earth around itself", null, 2, 0, 5, null, "https://i.ibb.co/fxpkbDm/images-q-tbn-ANd9-Gc-T4en1-Ri-Vtz-Yv6e-Jmuri7-O0-QW4-LRo9-Vgg-I0x-A-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8873) },
                    { 14, null, "The continent is a wide area of   land surrounded by seas and continents are Asia, Africa, America, Oceania, and occupies less than a third of the surface of the globe", null, 2, 2, 2, null, "https://i.ibb.co/BL5BXgK/images-q-tbn-ANd9-Gc-SPjgo-Jxn1y-R7-MDYLFWl-z4-IC2-Nl-Ue-Ynv-Ngw-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8881) },
                    { 15, null, "cumulus :  It is a group of pieces of rock that descended to a steep slope", null, 2, 2, 3, null, "https://i.ibb.co/m4bvDmn/images-q-tbn-ANd9-Gc-QIe-Gx5-RXZ9-IOLA3-Vd-Qdj-Jja-QN5-PPMHIu-ITQ-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8887) },
                    { 16, null, "marble : A metamorphic rock consisting of calcite, which is a variable limestone that can be polished beautifully", null, 2, 2, 4, null, "https://i.ibb.co/Drxh9D0/images-q-tbn-ANd9-Gc-Qqr-Tv-W9-VXykz-Ty-Cn-fb5-PKb-Aahf5-LZ50-Lb-FA-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8928) },
                    { 17, null, "The North Pole is the point located in the far north of the Earth's surface, and it is one of the two points through which the imaginary line passes, which is the axis of the Earth's rotation around itself.", null, 2, 2, 5, null, "https://i.ibb.co/CK7mrWp/images-q-tbn-ANd9-Gc-RBH7j95w-TEy-To2-Yk-Ax-l5-OUBKBl-OV6pm8-Q-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8937) },
                    { 18, null, "Kidney is not  the only excretory organ ,but it is the most imporatnt", null, 3, 0, 2, null, "https://i.ibb.co/QmL8M58/images-q-tbn-ANd9-Gc-TARvz-P4c87n-Sc3-NAEi-S7h-N9-NPyd-WKib8i-T4-A-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8945) },
                    { 19, null, "The Femur is the longest bone in the human body", null, 3, 0, 3, null, "https://i.ibb.co/gwfdm3v/images-q-tbn-ANd9-Gc-Tf-Sd-Tn-GYo-Usp-BMo9-O2-Gc-VKj-CMO0-Uh1nmk-N1w-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8953) },
                    { 20, null, "There are 4 loose ribs in the human body", null, 3, 0, 4, null, "https://i.ibb.co/vVp4VzG/images-q-tbn-ANd9-Gc-Rkmc-W2v-ML6h-1-Yg8-RE2-Hg-Zu-E8-Kw6k-Tc-Z137w-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8960) },
                    { 21, null, "When inhaling, the diaphragm muscle contracts", null, 3, 0, 5, null, "https://i.ibb.co/YWjxCXv/images-q-tbn-ANd9-Gc-Tu5t7j-Sn-kr-C8-Efd-IXFy-Yr4n-urcl-Hf-Wdp4-Q-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8968) },
                    { 22, null, "Most food is absorbed in the intestines", null, 3, 3, 2, null, "https://i.ibb.co/2gkLWn8/images-q-tbn-ANd9-Gc-QC2ab6-XMXlj-8-Vh3g-VH3r-ZRAwjcjlqo-EPw-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8975) },
                    { 23, null, "The tricuspid valve is located between the right atrium and the right ventricle", null, 3, 3, 3, null, "https://i.ibb.co/0CnFs85/images-q-tbn-ANd9-Gc-Rkcx-1-KTBm3-p-SAtz-Cb8-Dbci4-QVc-MJ8-Ged-PQ-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8982) },
                    { 24, null, "There are 7 cervical vertebrae, 12 thoracic vertebrae, 5 lumbar vertebrae, 5 sacral vertebrae, and 4 coccygeal vertebrae.", null, 3, 3, 4, null, "https://i.ibb.co/W2bgDHp/images-q-tbn-ANd9-Gc-Qf-YZFRrsfia-Ja-Ly-MP2eb-BLy-DJMdtbu-E44ka-A-s.png", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8990) },
                    { 25, null, "The eye lives within a cavity called the pilgrims", null, 3, 3, 5, null, "https://i.ibb.co/kcBGpyJ/images-q-tbn-ANd9-Gc-TH7-LLr3-Yv5-GJfe-B5n-ARhsr-B3-Azoqnf-QLb-V6-Q-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(8997) },
                    { 26, null, "The most used application is Facebook, with 1.3 billion users, while the second most used application is WeChat, with 1.26 billion users.", null, 4, 0, 2, null, "https://i.ibb.co/pKbKCFB/images-q-tbn-ANd9-Gc-QR4q8-OUDk-OYe-GIs0-Oa44-Uth-A-ZFLtq5eqy-YQ-s.png", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(9003) },
                    { 27, null, "PAN, LAN, MAN, GAN, WAN and VPN are a kind of networking technology", null, 4, 0, 3, null, "https://i.ibb.co/T4K2bbx/images-q-tbn-ANd9-Gc-Rqu-J0-JYPrc10-Laeh-JFzgl-Vdotdn3-Bx-IT07-Zg-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(9011) },
                    { 28, null, "SD-WAN is one of the fastest emerging segments in network technologies over the past two years", null, 4, 0, 4, null, "https://i.ibb.co/NKXCNCr/images-q-tbn-ANd9-Gc-R3-Rzq-Exfg-P81904m-Nutu6l-XF-QVVNvpdrrcw-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(9018) },
                    { 29, null, "Artificial intelligence  - Artificial Intelligence - is a simulation and tradition of human intelligence in the machines programmed to think such as humans and images their actions such as electronic devices and robots, this term can also indicate any machine that displays attributes related to the human mind such as learning and solving problems", null, 4, 0, 5, null, "https://i.ibb.co/c871rk0/images-q-tbn-ANd9-Gc-R9c-Yn8-Y9k0-RBx-H0l-Pu3-Ys7-C5f-288cwvads-A-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(9025) },
                    { 30, null, "A GPU is a processor similar to the one on a computer's motherboard.  The job that the graphics card processor performs is to keep the graphics card connected to the computer system.  It is considered the most important component of the graphics card that processes graphics, and the graphics card processor is not separable, that is, it cannot be updated to a higher category.", null, 4, 4, 2, null, "https://i.ibb.co/txX97yK/images-q-tbn-ANd9-Gc-RU48-LUUzj-j-Eg-FU3x-Aq-Ze7rr-Tlc3jbp-Es-Qcg-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(9032) },
                    { 31, null, "CPU is a machine or an electrical circuit that operates other machines or electronic circuits by giving them orders to perform operations or algorithms;  Most of these operations are data processing.", null, 4, 4, 3, null, "https://i.ibb.co/JFNGGw4/images-q-tbn-ANd9-Gc-Sh4-J-1o0u-OQDY22-BOX1-DTSi76os-KCsn-Euy-Cg-s.png", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(9039) },
                    { 32, null, "Deepfake or deep falsification is a technique used to fake video clips in a way that makes it difficult for humans to distinguish between what is real and what is fake", null, 4, 4, 4, null, "https://i.ibb.co/qFxBC4j/images-q-tbn-ANd9-Gc-Sgw-Jj-CVXTu-Cx-Re-Qm-KZju-Yzvk-LY0-N0-Fx-T4w-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(9046) },
                    { 33, null, "Bots download, Spam bots, Ticket Bots, Distributed Denial of Service (DDoS) bots, Fraudulent bots, File sharing bots and Social media bots are kind of Malicious bots", null, 4, 4, 5, null, "https://i.ibb.co/LZKv73q/images-q-tbn-ANd9-Gc-S9-O4-MIX7xl-GVVk6v01c2-Yf1-VFxib-Ys-Ls-Yf-Q-s.jpg", null, new DateTime(2025, 2, 8, 23, 4, 55, 296, DateTimeKind.Local).AddTicks(9054) }
                });
